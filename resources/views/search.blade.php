...
<header><div class="logo_wrapper"><a href="index.html" class="logo"><img src="{{asset(' images/logo.png')}} " alt=""></a></div></header>
...
<h2 class="center"><span>Search result:</span></h2>
...
<div class="logo2_wrapper"><a href="index.html" class="logo2"><img src="{{asset('images/logo2.png')}} " alt=""></a></div>
...
<div class="social_wrapper">
    ...
    <li><a href="#"><img src="{{asset('images/social_ic1.png')}}  "></a></li>
    <li><a href="#"><img src="{{asset(' images/social_ic2.png')}} "></a></li>
    <li><a href="#"><img src="{{asset('images/social_ic3.png')}}  "></a></li>
    <li><a href="#"><img src="{{asset('images/social_ic4.png')}}  "></a></li>
    <li><a href="#"><img src="{{asset('images/social_ic5.png')}}  "></a></li>
    <li><a href="#"><img src="{{asset(' images/social_ic6.png')}} "></a></li>
	</ul>
</div>
